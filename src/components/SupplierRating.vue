    <template>
        ...
        <div class="flex items-center mb-4">
            <span class="mr-2">Rate this supplier:</span>
            <div class="flex">
            <!-- Loop to display 5 stars -->
            <template v-for="star in 5" :key="star">
                <svg
                @click="rateSupplier(star)"
    ...
    // Define props to receive supplierId from parent component
    ...
    const submitRating = async () => {
        ...
        try {
        await addDoc(collection(db, 'supplierRatings'), {
            supplierId: props.supplierId,  // Supplier ID
